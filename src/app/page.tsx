...
import { MapPin, LayoutGrid, Video, Github, Sparkles, Smartphone } from "lucide-react";
import { MOROCCO_PLACES, CATEGORIES } from "@/lib/mtd-data";

const sections = [
  { href: "/morocco", title: "Morocco", body: "Imperial cities, kasbahs, Sahara, Atlas, food.", icon: MapPin },
  { href: "/scroller", title: "Scroller", body: "Vertical feed of Morocco.", icon: Smartphone },
